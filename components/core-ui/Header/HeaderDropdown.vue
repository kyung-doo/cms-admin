<template>
      <b-nav-item-dropdown right no-caret>
        <template slot="button-content">
          <img v-if="$store.state.admin && $store.state.admin.photo" :src="$uploadUrl+$store.state.admin.photo" class="img-avatar" />
        ...
        <b-dropdown-item><i class="fa fa-lock"></i> 홈페이지로 이동</b-dropdown-item>
